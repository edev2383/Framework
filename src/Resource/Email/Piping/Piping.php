...
use Edev\Model\Client\EmailPiping;
...
class Piping
{
    ...
    private $_masterRootEmail = 'jeff@jasoncases.com';
    ...
    private function _to()
    {
        ...
        $this->_to = Employee::where('id', $id)->get('email');
    }
    ...
    {
        $headers = "From: Edev <email-routing@zerodock.com> \r\n";

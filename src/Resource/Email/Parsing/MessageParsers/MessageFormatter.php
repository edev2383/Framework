...
class MessageFormatter
{
    ...
    private function _format($messageArray)
    {
     ...
     * @return void
     */
    private function _recombineLines()
    {
     ...
     * @return string
     */
    private function _allStringFormatting($str)
    {
     ...
     * @return string
     */
    private function _searchAndReplace($str)
    {
     ...
     * @return string
     */
    private function _parseUrls($str)
    {
        $re = '/^(http:\/\/|https:\/\/)?(.*?\.)?(.*?).com/';
     ...
     * @return string
     */
    private function _renderAnchorTag($url, $domain)
    {
